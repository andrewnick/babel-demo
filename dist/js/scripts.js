...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PointJs = __webpack_require__(3);
	...
	window.onload = function () {
	  ...
	  location.html('Good point: ' + new _PointJs2['default'](2, 23));
	  sum[0].innerHTML = 'Good point: ' + new _PointJs2['default'](2, 24).Sum();

	  console.log((0, _lodash.zip)(['1', '2'], ['a', 'b']));
	};
